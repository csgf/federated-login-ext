    ...
    A.Get.script('https://code.jquery.com/jquery-1.5.2.min.js', {
        onSuccess: function() {
            ...
            $(function($) {
                ...
                var loadingErrorText = "Map loading error!"; // the loading error text
...
// STANDARD FEATURES
                ...
                $.defaultClickAction = function(e) {
                    ...
                    // Added by jalcaldemorano ----------------------------
                    //document.getElementById('input').value = url.substring(1);
                    // ----------------------------------------------------

                    $("input[id$=_citizenCountry]").each(function(){
                        $(this).val(url.substring(1));
                    });
